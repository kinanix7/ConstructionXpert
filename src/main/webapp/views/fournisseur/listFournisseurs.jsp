...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="page-header">List Fournisseurs</h2>
        <a href="<%=request.getContextPath()%>/fournisseurs/add" class="add-button">
            <i class="fas fa-plus-circle"></i> Add New Fournisseur
        </a>
    </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-80">
                ...
                <div class="card-content">
                    <h4 class="fournisseur-title"><%= fournisseur.getNom() %></h4>

                    <div class="fournisseur-description">
                        <div class="info-label"><i class="fas fa-user"></i> Contact:</div>
                        <p><%= fournisseur.getContact() != null ? fournisseur.getContact() : "No contact available" %></p>
                    </div>

                    <div class="info-section">
                        <div class="info-label"><i class="fas fa-envelope"></i> Email:</div>
                        <p class="info-value"><%= fournisseur.getEmail() %></p>
                    </div>

                    <div class="info-section">
                        <div class="info-label"><i class="fas fa-phone"></i> Telephone:</div>
                        <p class="info-value"><%= fournisseur.getTelephone() != null ? fournisseur.getTelephone() : "No telephone available" %></p>
                    </div>
                </div>
